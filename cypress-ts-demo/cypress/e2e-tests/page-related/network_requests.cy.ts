import { NetworkRequestsPage } from '../../page-object-model/index';

describe('Network Requests with Page Objects', () => {
  let networkPage: NetworkRequestsPage;
  ...
  it('cy.request() - make an XHR request', () => {
    ...
    networkPage
      .makeGetRequest('https://jsonplaceholder.cypress.io/comments')
      .should((response) => {
  ...
  it('cy.request() with query parameters', () => {
    ...
    networkPage
      .makeGetRequestWithQuery('https://jsonplaceholder.cypress.io/comments', {
        postId: 1,
        id: 3,
      })
      .its('body')
